...
"use strict";function financeSlider(){new Swiper(".finance__slider-container",{navigation:{nextEl:".finance__toggle-next",prevEl:".finance__toggle-prev"}})}$(document).ready(function(){financeSlider(),menuToggle(),featuresSlider(),maskFunc(),popupShow(),popupClose(),overlayClose(),selectedItems()});var headerBurger=document.querySelector(".header__burger"),header=document.querySelector(".header__inner"),body=document.querySelector("body");function menuToggle(){$(window).width()<1024&&($(headerBurger).on("click",function(e){$(header).toggleClass("header__inner--active"),$(body).toggleClass("no-scroll")}),$(".header__menu-toggle--submenu").on("click",function(e){e.preventDefault(),$(this).parent(".header__menu-item").toggleClass("header__menu-item--active")}))}function popupShow(){$(".js-popup-toggle").on("click",function(e){e.preventDefault(),console.log("sass"),$(".popup").addClass("popup--active"),$(".popup-overlay").addClass("popup-overlay--active"),$("body").addClass("no-scroll"),$("html").addClass("no-scroll"),$(header).removeClass("header__inner--active")})}function popupClose(){$(".popup__close").on("click",function(e){e.preventDefault(),$(this).parent(".popup__header").parent(".popup").removeClass("popup--active"),$(".popup-overlay").removeClass("popup-overlay--active"),$("body").removeClass("no-scroll"),$("html").removeClass("no-scroll")})}function overlayClose(){$(".popup-overlay").on("click",function(e){$(this).removeClass("popup-overlay--active"),$(".popup").removeClass("popup--active"),$("body").removeClass("no-scroll"),$("html").removeClass("no-scroll")})}function featuresSlider(){$(window).width()<768&&new Swiper(".features__list",{slidesPerView:"auto",spaceBetween:12})}function selectedItems(){$(".credit-list").select2({placeholder:"Выберите тип кредита:"}),$(".location-list").select2({placeholder:"Ваш регион проживания:"})}function maskFunc(){var e=document.querySelectorAll(".phone"),o={mask:"+7(000)000-00-00",lazy:!1},a=[];e.forEach(function(e,t){a[t]=new IMask(e,o)})}document.addEventListener("DOMContentLoaded",function(){var a=document.querySelectorAll(".js-vacancy-toggle");a.forEach(function(e){e.addEventListener("click",function(e){e.preventDefault();var t=e.currentTarget,o=t.closest(".vacancy__item").querySelector(".vacancy__top"),e=t.closest(".vacancy__item").querySelector(".vacancy__info");t.closest(".vacancy__item").classList.contains("vacancy__item--open")?a.forEach(function(e){e.closest(".vacancy__item").classList.remove("vacancy__item--open"),e.closest(".vacancy__item").querySelector(".vacancy__info").style.maxHeight=null}):(a.forEach(function(e){e.closest(".vacancy__item").classList.remove("vacancy__item--open"),e.closest(".vacancy__item").querySelector(".vacancy__info").style.maxHeight=null}),t.closest(".vacancy__item").classList.add("vacancy__item--open")),t.closest(".vacancy__item").classList.contains("vacancy__item--open")?(o.setAttribute("aria-expanded",!0),e.setAttribute("aria-hidden",!1),e.style.maxHeight=e.scrollHeight+"px"):(o.setAttribute("aria-expanded",!1),e.setAttribute("aria-hidden",!0),e.style.maxHeight=null)})})});