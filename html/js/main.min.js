...
"use strict";function financeSlider(){new Swiper(".finance__slider-container",{navigation:{nextEl:".finance__toggle-next",prevEl:".finance__toggle-prev"}})}$(document).ready(function(){financeSlider(),menuToggle(),featuresSlider(),maskFunc(),popupShow(),popupClose(),overlayClose()});var headerBurger=document.querySelector(".header__burger"),header=document.querySelector(".header__inner"),body=document.querySelector("body");function menuToggle(){$(window).width()<1024&&($(headerBurger).on("click",function(e){$(header).toggleClass("header__inner--active"),$(body).toggleClass("no-scroll")}),$(".header__menu-toggle--submenu").on("click",function(e){e.preventDefault(),$(this).parent(".header__menu-item").toggleClass("header__menu-item--active")}))}function popupShow(){$(".js-popup-toggle").on("click",function(e){e.preventDefault(),console.log("sass"),$(".popup").addClass("popup--active"),$(".popup-overlay").addClass("popup-overlay--active"),$("body").addClass("no-scroll"),$(header).removeClass("header__inner--active")})}function popupClose(){$(".popup__close").on("click",function(e){e.preventDefault(),$(this).parent(".popup__header").parent(".popup").removeClass("popup--active"),$(".popup-overlay").removeClass("popup-overlay--active"),$("body").removeClass("no-scroll")})}function overlayClose(){$(".popup-overlay").on("click",function(e){$(this).removeClass("popup-overlay--active"),$(".popup").removeClass("popup--active"),$("body").removeClass("no-scroll")})}function featuresSlider(){$(window).width()<768&&new Swiper(".features__list",{slidesPerView:"auto",spaceBetween:12})}function maskFunc(){var e=document.querySelectorAll(".phone"),n={mask:"+7(000)000-00-00",lazy:!1},a=[];e.forEach(function(e,t){a[t]=new IMask(e,n)})}document.addEventListener("DOMContentLoaded",function(){var a=document.querySelectorAll(".vacancy__item");a.forEach(function(e){e.addEventListener("click",function(e){var t=e.currentTarget,n=t.querySelector(".vacancy__top"),e=t.querySelector(".vacancy__info");t.classList.contains("vacancy__item--open")?a.forEach(function(e){e.classList.remove("vacancy__item--open"),e.querySelector(".vacancy__info").style.maxHeight=null}):(a.forEach(function(e){e.classList.remove("vacancy__item--open"),e.querySelector(".vacancy__info").style.maxHeight=null}),t.classList.add("vacancy__item--open")),t.classList.contains("vacancy__item--open")?(n.setAttribute("aria-expanded",!0),e.setAttribute("aria-hidden",!1),e.style.maxHeight=e.scrollHeight+"px"):(n.setAttribute("aria-expanded",!1),e.setAttribute("aria-hidden",!0),e.style.maxHeight=null)}),$(".vacancy__btn").on("click",function(e){e.preventDefault()})})}),document.addEventListener("DOMContentLoaded",function(){var o=document.querySelectorAll(".vacancy__item");o.forEach(function(e){var t=o.currentTarget,n=t.querySelector(".vacancy__top"),a=t.querySelector(".vacancy__info");$(".js-vacancy-toggle").on("click",function(e){e.preventDefault(),t.classList.contains("vacancy__item--open")?o.forEach(function(e){e.classList.remove("vacancy__item--open"),e.querySelector(".vacancy__info").style.maxHeight=null}):(o.forEach(function(e){e.classList.remove("vacancy__item--open"),e.querySelector(".vacancy__info").style.maxHeight=null}),t.classList.add("vacancy__item--open")),t.classList.contains("vacancy__item--open")?(n.setAttribute("aria-expanded",!0),a.setAttribute("aria-hidden",!1),a.style.maxHeight=a.scrollHeight+"px"):(n.setAttribute("aria-expanded",!1),a.setAttribute("aria-hidden",!0),a.style.maxHeight=null)}),$(".vacancy__btn").on("click",function(e){e.preventDefault()})})}),$(".credit-list").select2({placeholder:"Выберите тип кредита:"}),$(".location-list").select2({placeholder:"Ваш регион проживания:"});